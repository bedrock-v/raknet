...
pub const err_code_pong_data_too_large = 10_009
...
pub const err_pong_data_too_large = error_with_code('pong data must be no longer than ${max_i16} bytes',
...
// background_read_poll_interval bounds how long a background reader loop
// (Listener.loop, client_loop) can block inside a single socket read call.
const background_read_poll_interval = 250 * time.millisecond
